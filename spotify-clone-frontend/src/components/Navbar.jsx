    ...
    <>
        <div className="w-full flex justify-between items-center font-semibold">
            ...
            <div className="flex items-center gap-4">
                <p className='bg-white text-black text-[15px] px-4 py-1 rounded-2xl hidden md:block cursor-pointer hover:bg-[black] hover:text-white'>Explore Premium</p>
                <p className='bg-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer hover:bg-white hover:text-black'>Install App</p>
                <p className='bg-sky-400 text-black w-7 h-7 rounded-full flex items-center justify-center'>A</p>
            </div>
        </div>
